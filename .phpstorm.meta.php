...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'ckfinder.loadRoutes' => 'boolean',
            'ckfinder.authentication' => 'string',
            'ckfinder.licenseName' => 'string',
            'ckfinder.licenseKey' => 'string',
            'ckfinder.privateDir.backend' => 'string',
            'ckfinder.privateDir.tags' => 'string',
            'ckfinder.privateDir.cache' => 'string',
            'ckfinder.privateDir.thumbs' => 'string',
            'ckfinder.privateDir.logs.backend' => 'string',
            'ckfinder.privateDir.logs.path' => 'string',
            'ckfinder.images.maxWidth' => 'integer',
            'ckfinder.images.maxHeight' => 'integer',
            'ckfinder.images.quality' => 'integer',
            'ckfinder.images.sizes.small.width' => 'integer',
            'ckfinder.images.sizes.small.height' => 'integer',
            'ckfinder.images.sizes.small.quality' => 'integer',
            'ckfinder.images.sizes.medium.width' => 'integer',
            'ckfinder.images.sizes.medium.height' => 'integer',
            'ckfinder.images.sizes.medium.quality' => 'integer',
            'ckfinder.images.sizes.large.width' => 'integer',
            'ckfinder.images.sizes.large.height' => 'integer',
            'ckfinder.images.sizes.large.quality' => 'integer',
            'ckfinder.backends.laravel_cache.name' => 'string',
            'ckfinder.backends.laravel_cache.adapter' => 'string',
            'ckfinder.backends.laravel_cache.root' => 'string',
            'ckfinder.backends.laravel_logs.name' => 'string',
            'ckfinder.backends.laravel_logs.adapter' => 'string',
            'ckfinder.backends.laravel_logs.root' => 'string',
            'ckfinder.backends.default.name' => 'string',
            'ckfinder.backends.default.adapter' => 'string',
            'ckfinder.backends.default.baseUrl' => 'string',
            'ckfinder.backends.default.root' => 'string',
            'ckfinder.backends.default.chmodFiles' => 'integer',
            'ckfinder.backends.default.chmodFolders' => 'integer',
            'ckfinder.backends.default.filesystemEncoding' => 'string',
            'ckfinder.defaultResourceTypes' => 'string',
            'ckfinder.resourceTypes.0.name' => 'string',
            'ckfinder.resourceTypes.0.directory' => 'string',
            'ckfinder.resourceTypes.0.maxSize' => 'integer',
            'ckfinder.resourceTypes.0.allowedExtensions' => 'string',
            'ckfinder.resourceTypes.0.deniedExtensions' => 'string',
            'ckfinder.resourceTypes.0.backend' => 'string',
            'ckfinder.resourceTypes.1.name' => 'string',
            'ckfinder.resourceTypes.1.directory' => 'string',
            'ckfinder.resourceTypes.1.maxSize' => 'integer',
            'ckfinder.resourceTypes.1.allowedExtensions' => 'string',
            'ckfinder.resourceTypes.1.deniedExtensions' => 'string',
            'ckfinder.resourceTypes.1.backend' => 'string',
            'ckfinder.roleSessionVar' => 'string',
            'ckfinder.accessControl.0.role' => 'string',
            'ckfinder.accessControl.0.resourceType' => 'string',
            'ckfinder.accessControl.0.folder' => 'string',
            'ckfinder.accessControl.0.FOLDER_VIEW' => 'boolean',
            'ckfinder.accessControl.0.FOLDER_CREATE' => 'boolean',
            'ckfinder.accessControl.0.FOLDER_RENAME' => 'boolean',
            'ckfinder.accessControl.0.FOLDER_DELETE' => 'boolean',
            'ckfinder.accessControl.0.FILE_VIEW' => 'boolean',
            'ckfinder.accessControl.0.FILE_UPLOAD' => 'boolean',
            'ckfinder.accessControl.0.FILE_RENAME' => 'boolean',
            'ckfinder.accessControl.0.FILE_DELETE' => 'boolean',
            'ckfinder.accessControl.0.IMAGE_RESIZE' => 'boolean',
            'ckfinder.accessControl.0.IMAGE_RESIZE_CUSTOM' => 'boolean',
            'ckfinder.overwriteOnUpload' => 'boolean',
            'ckfinder.checkDoubleExtension' => 'boolean',
            'ckfinder.disallowUnsafeCharacters' => 'boolean',
            'ckfinder.secureImageUploads' => 'boolean',
            'ckfinder.checkSizeAfterScaling' => 'boolean',
            'ckfinder.htmlExtensions' => 'array',
            'ckfinder.hideFolders' => 'array',
            'ckfinder.hideFiles' => 'array',
            'ckfinder.forceAscii' => 'boolean',
            'ckfinder.xSendfile' => 'boolean',
            'ckfinder.debug' => 'boolean',
            'ckfinder.plugins' => 'array',
            'ckfinder.cache.imagePreview' => 'integer',
            'ckfinder.cache.thumbnails' => 'integer',
            'ckfinder.tempDirectory' => 'string',
            'ckfinder.sessionWriteClose' => 'boolean',
            'ckfinder.csrfProtection' => 'boolean',
            ...
            'filesystems.links./media/datdn/Data/Linux/laravel/kingexpresstravel.com/public/storage' => 'string',
...
'cache.stores.octane.driver','cache.prefix','ckfinder.loadRoutes','ckfinder.authentication','ckfinder.licenseName',
'ckfinder.licenseKey','ckfinder.privateDir.backend','ckfinder.privateDir.tags','ckfinder.privateDir.cache','ckfinder.privateDir.thumbs',
'ckfinder.privateDir.logs.backend','ckfinder.privateDir.logs.path','ckfinder.images.maxWidth','ckfinder.images.maxHeight','ckfinder.images.quality',
'ckfinder.images.sizes.small.width','ckfinder.images.sizes.small.height','ckfinder.images.sizes.small.quality','ckfinder.images.sizes.medium.width','ckfinder.images.sizes.medium.height',
'ckfinder.images.sizes.medium.quality','ckfinder.images.sizes.large.width','ckfinder.images.sizes.large.height','ckfinder.images.sizes.large.quality','ckfinder.backends.laravel_cache.name',
'ckfinder.backends.laravel_cache.adapter','ckfinder.backends.laravel_cache.root','ckfinder.backends.laravel_logs.name','ckfinder.backends.laravel_logs.adapter','ckfinder.backends.laravel_logs.root',
'ckfinder.backends.default.name','ckfinder.backends.default.adapter','ckfinder.backends.default.baseUrl','ckfinder.backends.default.root','ckfinder.backends.default.chmodFiles',
'ckfinder.backends.default.chmodFolders','ckfinder.backends.default.filesystemEncoding','ckfinder.defaultResourceTypes','ckfinder.resourceTypes.0.name','ckfinder.resourceTypes.0.directory',
'ckfinder.resourceTypes.0.maxSize','ckfinder.resourceTypes.0.allowedExtensions','ckfinder.resourceTypes.0.deniedExtensions','ckfinder.resourceTypes.0.backend','ckfinder.resourceTypes.1.name',
'ckfinder.resourceTypes.1.directory','ckfinder.resourceTypes.1.maxSize','ckfinder.resourceTypes.1.allowedExtensions','ckfinder.resourceTypes.1.deniedExtensions','ckfinder.resourceTypes.1.backend',
'ckfinder.roleSessionVar','ckfinder.accessControl.0.role','ckfinder.accessControl.0.resourceType','ckfinder.accessControl.0.folder','ckfinder.accessControl.0.FOLDER_VIEW',
'ckfinder.accessControl.0.FOLDER_CREATE','ckfinder.accessControl.0.FOLDER_RENAME','ckfinder.accessControl.0.FOLDER_DELETE','ckfinder.accessControl.0.FILE_VIEW','ckfinder.accessControl.0.FILE_UPLOAD',
'ckfinder.accessControl.0.FILE_RENAME','ckfinder.accessControl.0.FILE_DELETE','ckfinder.accessControl.0.IMAGE_RESIZE','ckfinder.accessControl.0.IMAGE_RESIZE_CUSTOM','ckfinder.overwriteOnUpload',
'ckfinder.checkDoubleExtension','ckfinder.disallowUnsafeCharacters','ckfinder.secureImageUploads','ckfinder.checkSizeAfterScaling','ckfinder.htmlExtensions',
'ckfinder.hideFolders','ckfinder.hideFiles','ckfinder.forceAscii','ckfinder.xSendfile','ckfinder.debug',
'ckfinder.plugins','ckfinder.cache.imagePreview','ckfinder.cache.thumbnails','ckfinder.tempDirectory','ckfinder.sessionWriteClose',
'ckfinder.csrfProtection','database.default','database.connections.sqlite.driver','database.connections.sqlite.url','database.connections.sqlite.database',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./media/datdn/Data/Linux/laravel/kingexpresstravel.com/public/storage','logging.default','logging.deprecations.channel',
...
'ckfinder_connector','ckfinder_browser','admin.login',
'admin.logout','admin.authenticate','admin.dashboard.index','admin.categories.index','admin.categories.create',
'admin.categories.store','admin.categories.show','admin.categories.edit','admin.categories.update','admin.categories.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'admin.auth.login','admin.layouts.main','admin.layouts.partials.footer','admin.layouts.partials.head','admin.layouts.partials.header',
'admin.layouts.partials.scripts','admin.layouts.partials.sidebar','admin.modules.categories.createOrEdit','admin.modules.categories.index','admin.modules.dashboard.index',
'admin.partials.alerts','ckfinder::browser','ckfinder::setup','components.inputs.date','components.inputs.editor',
'components.inputs.editor-array','components.inputs.email','components.inputs.file-link','components.inputs.image-link','components.inputs.image-link-array',
'components.inputs.number','components.inputs.select','components.inputs.select-multiple','components.inputs.select-simple','components.inputs.text',
'components.inputs.text-area','components.inputs.text-area-array','components.inputs.text-array','components.inputs.time','components.menus.menu-bar',
'components.menus.menu-item','vendor.ckfinder.browser','vendor.ckfinder.setup','ckfinder::browser','ckfinder::samples.ckeditor',
'ckfinder::samples.full-page','ckfinder::samples.full-page-open','ckfinder::samples.index','ckfinder::samples.layout','ckfinder::samples.localization',
'ckfinder::samples.modals','ckfinder::samples.other-custom-configuration','ckfinder::samples.other-read-only','ckfinder::samples.plugin-examples','ckfinder::samples.popups',
'ckfinder::samples.skins-jquery-mobile','ckfinder::samples.skins-moono','ckfinder::samples.user-interface-compact','ckfinder::samples.user-interface-default','ckfinder::samples.user-interface-listview',
'ckfinder::samples.user-interface-mobile','ckfinder::samples.widget','ckfinder::setup','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
