        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-9" id="profile-content-area">
                    ...
                    {{-- Modal được giữ lại ở đây vì nó là một phần của trang Lịch sử --}}
                    ...
                    {{-- Đặt script trong thẻ script thường thay vì @push --}}
                    <script>
                        (function() {
                            const paginationContainer = document.getElementById('pagination-container');
                            if (paginationContainer) {
                                // Logic tải thêm giữ nguyên...
                            }
                            ...
                            const toggleOtherReasonVisibility = () => {
                                const otherRadio = document.querySelector('input[name="reason_option"][value="other"]');
                            ...
                            reasonRadios.forEach(radio => {
                                radio.addEventListener('change', toggleOtherReasonVisibility);
                            });
