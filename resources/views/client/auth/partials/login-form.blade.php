<form action="{{ route('client.login.submit') }}" method="POST">
    ...
    <div class="mt-4 flex justify-between items-center text-sm">
        <div class="flex items-center">
            <input id="remember" name="remember" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-[var(--color-primary)] focus:ring-[var(--color-primary-accent)]">
    ...
    <div class="mt-4 text-center text-sm">
        ...
        <button type="button" data-modal-switch="register-modal" class="font-medium hover:cursor-pointer text-[var(--color-primary)] hover:underline">
            Đăng ký ngay
        </button>
    </div>
</form>
